...
<html lang="en">
  ...
  <h1><marquee behavior=scroll direction=left loop=15>SELAMAT DATANG DI UNIVERSITAS CATUR INSAN CENDEKIA</marquee></h1>
	<h2 class="teks-hitam"> Daftar Mahasiswa</h2>
	<br><br>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="/students/welcome">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/kontraks">Kontrak</a>
      </li>
      <li class="nav-item">
